...
function mainStart() {
    ...
    InstallModules(['minimist'], {}, function () {
        ...
        //if (config.settings.mongodb != null) { modules.push('mongodb@4.17.2'); } //modules.push('saslprep@1.0.3'); } // Add MongoDB, official driver.
        if (config.settings.mongodb != null) { modules.push('mongodb-legacy@6.1'); } //Add mongodb-legacy callback wrapper around latest mongodb driver.
